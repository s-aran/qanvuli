...
pub(crate) fn draw_help(frame: &mut ratatui::Frame<'_>) {
    ...
    let help = Paragraph::new(vec![
        ...
        Line::from("F5           Database maintenance"),
        Line::from("F8           Raw CVE/OSV JSON"),
        Line::from("F9           CWE catalog"),
        Line::from("F10          CAPEC catalog"),
        Line::from("/            Find in details"),
        Line::from("F4           Catalog filters in CWE/CAPEC mode"),
        Line::from("↑ / ↓        Move selection"),
        Line::from("Ctrl-U/D     Half page"),
        Line::from("Ctrl-B/F     Full page"),
